...
const RevenueByCategories = () => {
  ...
  const print = () => (
    <ReactToPrint
      ...
      documentTitle={t('dashboard.report.revenueByCategories')}
    />
  )

  return (
    <ReportCard
      title={t('dashboard.report.revenueByCategories')}
    ...
    >
      ...
      <FullScreenModal
        ...
        print={print()}
      >
        <div className="w-2/5 flex-1 m-auto flex items-center">
          {renderChart()}
        </div>
      </FullScreenModal>
    </ReportCard>
...
export default RevenueByCategories
