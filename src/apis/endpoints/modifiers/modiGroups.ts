...
export const useCreateModiGroupMutation = (
  ...
  return useMutation(['createModiGroup'], modigroups.create, options)
}

export const useUpdateModiGroupsMutation = (
  options?: MutationOptions<Response['update'], Variables['update']>
) => {
  return useMutation(['updateModiGroups'], modigroups.update, options)
}

export const useDeleteModiGroupsMutation = (
  options?: MutationOptions<Response['delete'], Variables['delete']>
) => {
  return useMutation(['deleteModiGroups'], modigroups.delete, options)
}
